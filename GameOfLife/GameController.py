...
class GameController:
    ...
    def update(self):
        """
        Aktualizuje stany komórek na planszy na podstawie zasad gry w życie.
        """
        for i in range(self.height):
            for j in range(self.width):
    ...
    def get_next_state(self, i, j):
        """
        Zwraca stan komórki na podstawie aktualnego stanu oraz liczby żywych sąsiadów.
    ...
    def count_live_neighbors(self, i, j):
        """
        Liczy liczbę żywych sąsiadów danej komórki.
